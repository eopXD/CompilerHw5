...
parser: parser.tab.o alloc.o functions.o symbolTable.o semanticAnalysis.o codeGen.o offset.o
	$(CC) -o $(TARGET) parser.tab.o alloc.o functions.o symbolTable.o semanticAnalysis.o codeGen.o offset.o $(LIBS)
